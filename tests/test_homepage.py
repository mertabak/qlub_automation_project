...
class TestHomepage:
    ...
    def test_split_the_bill_pay_for_your_items(self):
        ...
        basepage.is_element_presence(BasePage.PAY_FOR_YOUR_ITEMS)
        basepage.click_to_element(BasePage.PAY_FOR_YOUR_ITEMS_SELECT)
        basepage.is_element_presence(BasePage.FIRST_PLUS)
        basepage.is_element_presence(BasePage.THIRD_PLUS)
        ...
        basepage.is_element_presence(BasePage.PAYMENT_WAS_SUCCESSFUL)
    ...
    def test_split_the_bill_divide_the_bill_equally(self):
        ...
        basepage.scroll_the_page()
        basepage.click_to_element(BasePage.SPLIT_BILL)
        basepage.is_element_presence(BasePage.DIVIDE_THE_BILL_EQUALLY)
    ...
    def test_split_the_bill_pay_a_custom_amount(self):
        ...
        basepage.scroll_the_page()
        basepage.click_to_element(BasePage.SPLIT_BILL)
        basepage.is_element_presence(BasePage.PAY_A_CUSTOM_AMOUNT_BUTTON)
